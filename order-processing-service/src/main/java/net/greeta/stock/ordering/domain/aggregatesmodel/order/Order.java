...
import net.greeta.stock.ordering.domain.aggregatesmodel.order.rules.OrderMustBePaid;
import net.greeta.stock.ordering.domain.aggregatesmodel.order.rules.OrderMustNotBePaidOrShipped;
...
import net.greeta.stock.ordering.domain.events.*;
import net.greeta.stock.ordering.domain.base.AggregateRoot;
import lombok.Getter;
import lombok.Setter;
import net.greeta.stock.ordering.domain.aggregatesmodel.buyer.BuyerId;
import net.greeta.stock.ordering.domain.aggregatesmodel.buyer.PaymentMethodId;
import net.greeta.stock.ordering.domain.events.*;
