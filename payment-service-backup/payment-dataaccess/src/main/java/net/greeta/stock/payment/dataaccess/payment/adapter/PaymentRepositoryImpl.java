package net.greeta.stock.payment.dataaccess.payment.adapter;

import net.greeta.stock.payment.dataaccess.payment.repository.PaymentJpaRepository;
import net.greeta.stock.payment.dataaccess.payment.mapper.PaymentDataAccessMapper;
