...
@Slf4j
@Component
public class PaymentDepositOutboxHelper {

    private final PaymentDepositOutboxRepository paymentOutboxRepository;
    private final ObjectMapper objectMapper;

    public PaymentDepositOutboxHelper(PaymentDepositOutboxRepository paymentOutboxRepository,
